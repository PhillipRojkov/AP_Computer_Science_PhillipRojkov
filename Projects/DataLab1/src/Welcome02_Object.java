...
public class Welcome02_Object {
   public static void main(String[] args) {
      ...
      if (ob1.colderThan(ob2) && ob1.colderThan(ob3)) { //ob1 is coldest
         System.out.println("Colder at " + id1 + " than " + id2 + " and " + id3);
      } else if (ob2.colderThan(ob1) && ob2.colderThan(ob3)) { //ob2 is coldest
         System.out.println("Colder at " + id2 + " than " + id1 + " and " + id3);
      } else { //ob3 is coldest
         System.out.println("Colder at " + id3 + " than " + id1 + " and " + id2);
      }
   }
}
